...
export const products = [
  ...
  product('Paneer Finger', 'Hand Made Starters', 'https://res.cloudinary.com/thk8htfr/image/upload/v1783830099/panner_finger_jfxemn.png', 'Breaded paneer finger snack for starters and party menus.', ['Hand made', 'Ready to fry', 'Starter']),
  ...
  product('Veg Cutlet Hand Made', 'Hand Made Starters', 'https://res.cloudinary.com/thk8htfr/image/upload/v1783830102/veg_cutlet_tqjyes.png', 'Hand-made vegetable cutlet for snack counters and catering.', ['Hand made', 'Ready to fry', 'Catering']),
